        ...
        <nav class="bg-blue-500 mx-auto px-2 sm:px-6 lg:px-8">
              <div class="relative flex items-center justify-between h-16">
                <div class="absolute flex items-center sm:hidden">
                  <button type="button" id="mobileMenuButton" onClick={() => setNavbarOpen(!navbarOpen)} class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700">
                ...
                <div class="flex-1 flex items-center justify-start pl-10 sm:items-stretch">
                  <div class="flex-shrink-0 flex items-center">
                    <a href="index.html" class="text-white text-2xl"><i class="fas fa-carrot pr-2"></i>InstaKart</a>
                  </div>
                </div>
                ...
                <div class="absolute right-0 flex items-center pr-2 sm:ml-6 sm:pr-0">
                    ...
                    <div class="ml-3 relative">
                        <div>
                            <button type="button" class="flex text-sm" id="profileMenuButton">
